...
class UCFclassification(object):
    ...
    def evaluate(self):
        ...
        if self.verbose:
            ...
            print ('\tAccuray@{}: {}'.format(self.top_k, hit_at_k))
...
if __name__ == '__main__':
    gt_path = '/home/alireza/Desktop/I3D-RGB-branch/data/ucfTrainTestlist/ucf101_01.json'
    pred_path = '/home/alireza/Desktop/I3D-RGB-branch/data/results/resnet18_shortcutA_from_sctratch_model_bs128/val.json'

    ucf101 = UCFclassification(gt_path, pred_path, subset='validation', verbose=True, top_k=1) 
    ucf101.evaluate()
